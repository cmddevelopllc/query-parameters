...
var Tester = /** @class */ (function () {
    ...
    Tester.prototype.generalParse2 = function () {
        ...
        var parsed = parser.parse('${vip}&status=${sentStatus}&timestamp>2017-10-01&author.firstName=/john/i&limit=100&skip=50&sort=-timestamp&select=name&populate=children&page=1', predefined);
    ...
    Tester.prototype.parseCaster = function () {
        var parser = new _1.QueryParser({ casters: { $: function (val) { return '$' + val; } } });
        var qry = '_id=$(1)';
        var parsed = parser.parse(qry);
